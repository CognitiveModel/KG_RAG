...
query="What are the major points that any person should keep in mind while taking insurance of this company?"
# top_k = 3
...
edge_kg = Neo4jVector.from_existing_relationship_index(
        ...
        password=password,
        database="neo4j",  # neo4j by default
        index_name="edge-embedding",  # vector by default
        # text_node_property="content",  # text by default
        retrieval_query="""
...
docs_with_score = edge_kg.similarity_search_with_score(query, k=10)
